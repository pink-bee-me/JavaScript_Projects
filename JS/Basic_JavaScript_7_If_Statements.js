...
console.log(lastEyeExam + "  lastEyeExam"); // check value in console  
...
reminderMailedDate.setDate(reminderMailedDate.getDate() + daysDiff);
console.log(reminderMailedDate + "  reminderMailedDate");


 var  followUpDate = new Date(mailOutReminder);
      ...
      document.getElementById("Patient_Name").innerHTML= "Patient: " +  patient ;
       document.getElementById("Date_of_Last_Exam").innerHTML= "Date of Last Eye Exam: " + lastEyeExam;
        document.getElementById("Next_Yearly_Eye_Exam").innerHTML= "Next Yearly Eye Exam Due: " +  nextEyeExam;
          ...
          document.getElementById("Reminder").innerHTML= "Date To Mail Reminder: " +  mailOutReminder;
    

if  (daysDiff > 0) ; 
 document.getElementById("Not_Time_For_Reminder").innerHTML =  
 "Send Out Reminder - Past Due as of : " + mailOutReminder ;
 if ((mailOutReminder.getTime())> (currentDate.getTime())); document.getElementById("Not_Time_For_Reminder").innerHTML ="Not Time For Reminder!";
